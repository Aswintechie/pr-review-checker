...
function App() {
  ...
  const [showDomainDeprecationBanner, setShowDomainDeprecationBanner] = useState(false);
  ...
  useEffect(() => {
    const handleClickOutside = event => {
      ...
      // Banner doesn't close on outside click - removed domain deprecation notice click handling
    };
  ...
  const renderDomainDeprecationBanner = () => {
    ...
    return (
      <div className='domain-deprecation-banner'>
        <div className='banner-content'>
          ...
          <div className='banner-actions'>
            <button className='banner-btn primary' onClick={handleRedirect} type='button'>
              🚀 Switch to New Domain
            </button>
            <button className='banner-btn secondary' onClick={handleDismiss} type='button'>
              ✕ Dismiss
            </button>
          </div>
        </div>
